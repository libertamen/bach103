...
public class DateTime03 {
    ...
    public static void main(String[] args) {
        ...
        /*
        1- java da sabıt dataları(gun,ay Amerıkadakı eyalet ısımlerı etc v.b isimleri) depolamak ve gerektıgınde kullanmak ıcın depolar kullanırız.Bu depolara "Enum" denir.
         */
