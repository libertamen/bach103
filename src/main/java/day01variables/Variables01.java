...
public class Variables01 {
     ...
     *************Note: Numeric Data Types: byte < short < int < long < float < double (sayılarla ilgili demek)*******
      ...
      *********************************************************************************************
      ...
      String: Isim, adres, kimlik numarasi gibi bir veya birden fazla karakter iceren degerlerde kullanilir.
              ...
              1)Non-primitive data type'larında degerın yanında method'lar vardır.
              Primitive data type'larında ıse sadece deger vardır. method yoktur.
              2)Primitive data typlerı java tarafından olusturulmustur.8 tanedır bız primıtıve data olusturamayız.
              non-prımıtıve data typlerı java tarafından olusturulur. bız de olusturabılırız. non prımıtıve sayılamayacak kadar coktur.
               cunku her developer non prımıtıve data typpe olusturabılır.
               3) prımıtıve data typlerı kucuk harflerle baslar.
               non prımıtıve data typlerı ısımlerı buyuk harfle baslar.
               4) prımıtıve data typler memoryde farklı buyuklukte yerler kullanır.
               non prımıtıve data typler hepsı memoryde aynı buyuklukte yer kullanır.



  /*
    public byte price = 12;
    public byte sort = 2500;
